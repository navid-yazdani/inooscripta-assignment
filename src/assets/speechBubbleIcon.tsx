const SpeechBubbleIcon = ({color = "#000"}: {color?: string}) => {
    return (
        <svg width="20" height="20" viewBox="0 0 1024 1024" fill={color} x="244" y="244" role="img" xmlns="http://www.w3.org/2000/svg">
            <g fill={color}>
                <path fill={color}
